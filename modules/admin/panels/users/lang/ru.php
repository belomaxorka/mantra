...
return [
    ...
    'admin-users.create_error' => 'Не удалось создать пользователя. Имя или email могут быть заняты, либо не указан пароль.',
    'admin-users.update_error' => 'Не удалось обновить пользователя. Email может принадлежать другой учётной записи.',
