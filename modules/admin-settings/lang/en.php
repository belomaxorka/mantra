...
return array(
    ...
    'datetime.second.other' => 'seconds',
    'datetime.minute.one' => 'minute',
    'datetime.minute.other' => 'minutes',
    'datetime.hour.one' => 'hour',
    'datetime.hour.other' => 'hours',
    'datetime.day.one' => 'day',
    'datetime.day.other' => 'days',
    'datetime.month.one' => 'month',
    'datetime.month.other' => 'months',
    'datetime.year.one' => 'year',
    'datetime.year.other' => 'years',
);
